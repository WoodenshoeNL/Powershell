...
# Create a gateway IP configuration. The gateway picks up an IP address from the configured subnet 
...
# Configure the SKU for the application gateway, this determines the size and whether WAF is used.
